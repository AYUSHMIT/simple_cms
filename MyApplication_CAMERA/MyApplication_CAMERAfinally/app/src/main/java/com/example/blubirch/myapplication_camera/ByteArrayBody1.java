 ...
 * @since 4.1
 */
public class ByteArrayBody1 extends AbstractContentBody {
     ...
     */
    public ByteArrayBody1(final byte[] data, final String mimeType, final String filename,String s) {
        super(mimeType);
        if (data == null) {
     ...
     * @param filename The name of the file contained in this part.
     */
    public ByteArrayBody1(final byte[] data, final String filename,String s) {
        this(data, "application/octet-stream", filename,s);
    }
